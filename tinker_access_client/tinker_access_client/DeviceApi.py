...
class Channel(object):
    LCD, SERIAL, LED, PIN, TEMPERATURE = range(0, 5)
...
class DeviceApi(object):
    ...
    def __configure_tempsensor(self):
        try:	
            ...
            self.__device_file = device_folder + '/w1_slave'           # store the details
        except:
            self.__device_file = "NoSensor"
    ...
    def __read_temp(self):
       ...
       if lines == "NoSensor":
          return DeviceApi.NO_TEMPERATURE_INDICATOR, DeviceApi.NO_TEMPERATURE_INDICATOR
    ...
    def read(self, channel, *args):
        ...
        try:
            ...
            elif channel == Channel.TEMPERATURE:
                value = self.__read_temp()
